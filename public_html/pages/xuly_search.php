...
// XỬ LÝ THÔNG BÁO: Nếu từ khóa trống, bật Toast cảnh báo rồi quay lại trang chủ
if ($keyword == "") {
    ?>
    <!DOCTYPE html>
    <html lang="vi">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                Swal.fire({
                    ...
                    position: 'top-right',
                    icon: 'warning',
                    title: 'Vui lòng nhập từ khóa để !',
...
<body>
    ...
    <div class="container my-5" style="min-height: 400px;">
        ...
        <div class="row g-4">
            ...
            // Câu lệnh tìm kiếm theo tên hoặc mô tả
                        ...
                        <div class="card product-card shadow-sm h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="text-secondary small mb-3 mt-auto">
                                    <p class="mb-1"><i class="fa-solid fa-microchip me-1"></i> RAM: <?= htmlspecialchars($sp['ram'] ?? 'N/A') ?></p>
                                    <p class="mb-0"><i class="fa-solid fa-database me-1"></i> Bộ nhớ: <?= htmlspecialchars($sp['bonho'] ?? 'N/A') ?></p>
                                </div>
                            </div>
            ...
            <?php
                ...
                // Giao diện khi KHÔNG tìm thấy sản phẩm trùng khớp
                echo '
